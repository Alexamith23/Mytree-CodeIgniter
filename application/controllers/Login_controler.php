...
class Login_controler extends CI_Controller
{
    ...
    public function graf()
    {
        ...
        $extranjeros = $this->Login_modelo->extranjeros();
        $nacionales = $this->Login_modelo->nacionales();
        ...
        $this->session->set_userdata('extranjeros', $extranjeros);
        $this->session->set_userdata('nacionales', $nacionales);
        $this->load->view('Dasboard/Dashboard_Vista');
